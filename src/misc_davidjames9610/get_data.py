...
from src.misc_davidjames9610.annotations import Annotations, AnnotationsAudacity, Annotation
import decimal
import math
import librosa
import src.classifiers_davidjames9610.test_a.whale_data.constants as const
import pandas as pd
import numpy as np
...
class GetDataSimple:
    def __init__(self,
        ...
        self.location_of_wav_file = location_of_wav_file
        self.location_of_annotations = location_of_annotations
        audio = file_to_audio(location_of_wav_file, fs)
        self.audio = audio
        self.fs = fs
